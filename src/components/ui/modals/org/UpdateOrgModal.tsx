...
const UpdateDesignModal = (props) => {
  ...
  const { openModal, setOpenModal, findOrgs, org } = props;
  // HOOKS FORM **************************************************
  ...
  const [name, setName] = React.useState(org ? org.name : null);
  const [lastName, setLastName] = React.useState(org ? org.lastName : null);
  const [fatherName, setFatherName] = React.useState(
    org ? org.fatherName : null
  );
        ...
        <form onSubmit={submitForm}>
          ...
          >
            ...
            <Grid item xs={4.5}>
              <TextField
                margin="dense"
                defaultValue={org ? org.name : null}
                label="نام پدر"
                name="fatherName"
                size="small"
                sx={{ width: "100%" }}
            ...
            <Grid item xs={4.5} sx={{ mx: "auto" }}>
              <TextField
                margin="dense"
                label="نام خانوادگی"
                defaultValue={org ? org.agency : null}
                name="lastName"
                size="small"
                sx={{ width: "100%" }}
                onChange={(event) => {
