...
import bigLogoFooter from "../../../assests/img/big_logo-footer.png"
  ...
  return (
    ...
    <div className="col-12 ">
      ...
      <img
        src={bigLogoFooter}
        height="430"
        className="footer_bg-img d-none d-sm-block"
        alt=""
      />
                  ...
                  <div className="col-12 footer-col">
                    ...
                    <ul>
                      <li>
                        ...
                        <a  target="_blank" rel="noreferrer" href="https://jewelrydistricts.com">home</a>
                      </li>
                      <li>
                        
                        <a target="_blank" rel="noreferrer" href="https://jewelrydistricts.com/article/about_us">about us</a>
                      </li>
                      <li>
                        
                        <a target="_blank" rel="noreferrer" href="https://jewelrydistricts.com/article/what_we_do">what we do</a>
                      </li>
                  ...
                  <div className="col-12 footer-col">
                    ...
                    <ul>
                      <li>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://jewelrydistricts.com/article/what_we_do">general info</a>
                      </li>
                      <li>
                        
                        <a target="_blank" rel="noreferrer" href="https://jewelrydistricts.com/article/privacy_policy">privacy policy</a>
                      </li>
                      <li>
                        
                        <a target="_blank" rel="noreferrer" href="https://jewelrydistricts.com/article/product_information">Product Information</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="col-12 footer-col">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <a  target="_blank"  rel="noreferrer" href="https://jewelrydistricts.com/article/contact_us">contact us</a>
                      </li>
